...
export type ExpressionType = 'neutral' | 'happy' | 'sad' | 'angry' | 'surprised' | 'disgusted' | 'fearful' | 'contempt' | 'confused' | 'thinking' | 'skeptical' | 'determined' | 'empathetic' | 'excited' | 'bored' | 'focused' | 'amused' | 'concerned' | 'confident' | 'satisfied' | 'explaining';
